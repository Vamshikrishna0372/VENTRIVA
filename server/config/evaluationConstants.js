/**
 * Centralized Evaluation Weights & Scoring System
 * Total Weight Sum = 1.0 (100%)
 */
...
const EVALUATION_STATUSES = ['Draft', 'Completed'];

/**
 * Score Scale Descriptions (1 to 10)
 */
const SCORE_LABELS = {
  1: 'Very Weak',
  2: 'Weak',
...
/**
 * Calculate weighted overall evaluation score (1.0 to 10.0)
 * @param {Object} scores - Object containing category scores (1-10)
 * @returns {Number} overallScore rounded to 1 decimal place
 */
...
/**
 * Interpret overall score into visual status description
 */
